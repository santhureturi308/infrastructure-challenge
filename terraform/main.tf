...
# CloudFront Origin Access Identity (for future use with private bucket)
...
resource "aws_cloudfront_distribution" "website" {
  ...
  comment             = "CloudFront distribution for ${var.owner_name}'s website"
...
# CloudWatch Log Group for potential Lambda@Edge functions
resource "aws_cloudwatch_log_group" "website" {
  name              = "/aws/cloudfront/${aws_cloudfront_distribution.website.id}"
...
resource "aws_budgets_budget" "website" {
  ...
  cost_filters = {
    Tag = ["Project:infrastructure-challenge"]
  }
